...
class DetectNode:
    ...
    def __init__(self, model_type='detection', frames_per_det=30):
...
def main():
    ...
    rospy.init_node('DetectNode', anonymous=True)

    det = DetectNode()
    
    rospy.Timer(rospy.Duration(secs=5), det.apply_network)
